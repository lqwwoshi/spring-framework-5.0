...
final class PostProcessorRegistrationDelegate {
	...
	public static void invokeBeanFactoryPostProcessors(
		...
		//这里的是beanFactoryPostProcessors是程序员自定义的beanFactoryPostProcessor
		...
		if (beanFactory instanceof BeanDefinitionRegistry) {
			...
			//下面分两种
			//因为BeanFactoryProcessor有两种，一种是他自己
			//还有一种是BeanDefinitionRegistryPostProcessor
			// 这个接口继承了BeanFactoryProcessor，多增加了一个方法，
			//增加了原先BeanFactoryProcessor的能力。
			//这里只是将两种分别加到不同的集合里，因为
			// 实现了BeanDefinitionRegistryPostProcessor的也要调用他自己的那个方法
			...
			//其实如果没有自定义的，那就是ConfigurationClassPostProcessor
			...
			//其实这里就只有一个类，ConfigurationClassPostProcessor
	...
	public static void registerBeanPostProcessors(
		...
		//从beanDefinitionMap中得到所有的BeanPostProcessor,为了后面的注册
