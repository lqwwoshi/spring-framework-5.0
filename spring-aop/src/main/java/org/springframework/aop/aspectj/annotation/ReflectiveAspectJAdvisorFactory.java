...
public class ReflectiveAspectJAdvisorFactory extends AbstractAspectJAdvisorFactory implements Serializable {
	...
	public List<Advisor> getAdvisors(MetadataAwareAspectInstanceFactory aspectInstanceFactory) {
		...
		//我们使用的是包装模式来包装我们的MetadataAwareAspectInstanceFactory构建为LazySingletonAspectInstanceFactoryDecorator
	...
	//获取切面上的通知方法(exclude pointcut)，并按照规则排序
	private List<Method> getAdvisorMethods(Class<?> aspectClass) {
		...
		//按照默认规则排序，即Around.class, Before.class, After.class, AfterReturning.class, AfterThrowing.class顺序
	...
	public Advisor getAdvisor(Method candidateAdviceMethod, MetadataAwareAspectInstanceFactory aspectInstanceFactory,
		...
		//获取切点表达式，因为在getAdvisorMethods()时把pointcut exclude了
